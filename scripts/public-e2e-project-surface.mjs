...
try {
  ...
  await page.waitForFunction(() => document.body.dataset.timeCompassVersion === '20260914-compass5');
  ...
  assert.equal(await page.locator('body').getAttribute('data-time-compass-version'), '20260914-compass5');
